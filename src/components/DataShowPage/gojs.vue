<template>
      <div id="mygoChart" style="width:100%; height:400px; background-color: #ECA;">
        <!-- <canvas></canvas> -->
      </div>
</template>
...
export default {
  ...
  mounted() {
    ...
    [ // note that each node data object holds whatever properties it needs;
      ...
      {key:"2", parent:"1", name1: "秘书", name2: "秘书1", name3: "秘书2", linktext:"link"},
      {key:"3", parent:"1", name1: "CEO",  name2: "秘书1", name3: "秘书2", linktext:"link"},
      {key:"4", parent:"3", name1: "总经理",  name2: "秘书1", name3: "秘书2", linktext:"link"},
      {key:"5", parent:"4", name1: "二狗子",  name2: "秘书1", name3: "秘书2", linktext:"link"},
    ];
    
    mySelf.myDiagram.model = myModel;
    var mygoChart=document.getElementsByTagName("canvas");
    //obj元素上绑定click事件
    mygoChart[0].click()
    console.log(mygoChart[0])
  }
